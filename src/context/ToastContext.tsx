        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className="pointer-events-auto w-full p-4 rounded-xl shadow-2xl flex items-start gap-3 border backdrop-blur-xl bg-slate-900/95 transition-all text-slate-100"
              style={{
                borderColor:
                  toast.type === 'success'
                    ? 'rgba(16, 185, 129, 0.4)'
